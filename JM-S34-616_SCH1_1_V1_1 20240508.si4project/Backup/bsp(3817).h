...
#define Key3_IN_check	LL_GPIO_IsInputPinSet(GPIOA,LL_GPIO_PIN_3)
...
ex uint8_t R_Bat_Level_Temp_NanGao_Up_FangDou;
ex uint8_t R_Bat_Level_Temp_NanGao_Down_FangDou;
...
ex uint32_t R_Hearting_Time_Temp_WeiShu;
